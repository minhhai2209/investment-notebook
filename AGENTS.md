...
- Active model surface chỉ còn 2 model: `./broker.sh ohlc` dự báo giá T+n bằng `hist_gbm` và `./broker.sh intraday` dự báo close từ dữ liệu buổi sáng bằng `hist_gbm`.
