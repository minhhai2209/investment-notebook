...
Snapshot gốc: `2026-04-15T23:46:21.600978+07:00`
Archetype: `special situation / turnaround`
Market regime nền: `cân bằng`
...
- Ngành: `Bất động sản`; chế độ ngành hiện tại: `mixed`.
- Định giá snapshot: `PE_fwd 26.89 / PB 0.45 / ROE 3.00%`.
- Sức mạnh giá: `Ret20d +34.62% / Ret20dVsIndex +29.55% / RSI14 77.37 / ATR14Pct 4.68%`.
- Vị thế trong chu kỳ giá: `Pos52wPct 0.83 / High52w 19.30 / Low52w 8.93.`
- Cycle fit hiện tại: `1M` với đỉnh kỳ vọng `+7.57%` trong khoảng `7.20 phiên` và drawdown kỳ vọng `-8.63%.`
...
- Phong cách: `swing theo catalyst, mua sâu và trim vào hưng phấn`.
- Khung nắm giữ ưu tiên: `3-10 phiên, chỉ kéo dài nếu follow-through sạch`.
